...
<body class="u-body">
	  ...
	  <header class="u-clearfix u-header u-header" id="sec-a184"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="index.html" class="u-image u-logo u-image-1" data-image-width="862" data-image-height="771">
          <img src="assets/LOGOTESIS1.png" alt="Link a inicio" class="u-logo-image u-logo-image-1">
        </a>
        <a href="https://nicepage.com/website-design" class="u-border-none u-btn u-button-style u-gradient u-hover-palette-1-dark-1 u-none u-btn-1" style="visibility: hidden">Cerrar sesión</a>
        <h3 class="u-text u-text-default u-text-1">PulsiOxímetro</h3>
        <!-- <h6 class="u-text u-text-default u-text-2" style="visibility: hidden">Bienvenido Usuario</h6> -->
      </div></header>
	
	  <section class="u-align-center u-clearfix u-section-1" id="carousel_9c25">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-container-style u-gradient u-group u-radius-50 u-shape-round u-group-1">
          <div class="u-container-layout u-container-layout-1"><span class="u-custom-color-1 u-icon u-icon-circle u-spacing-22 u-text-white u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 60 60" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-c2f1"></use></svg><svg class="u-svg-content" viewBox="0 0 60 60" x="0px" y="0px" id="svg-c2f1" style="enable-background:new 0 0 60 60;"><path d="M48.014,42.889l-9.553-4.776C37.56,37.662,37,36.756,37,35.748v-3.381c0.229-0.28,0.47-0.599,0.719-0.951
...
?>
            ...
            <div class="u-form u-login-control u-white u-form-1">
              <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" id="form_session"  method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-20 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 30px;">
                ...
                <div class="u-form-group u-form-password">
                  ...
                  <input type="password" name="password" id="password" placeholder="Ingrese su contraseña" class="u-grey-5 u-input u-input-rectangle u-input-2" required="">
                </div>
            ...
            <a href="https://nicepage.one" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-grey-50 u-text-hover-black u-btn-2">Recuperar Contraseña?</a>
          </div>
        </div>
      </div>
    </section>
